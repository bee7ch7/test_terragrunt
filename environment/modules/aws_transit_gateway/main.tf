...
resource "aws_route" "this" {
  ...
  transit_gateway_id     = length(local.vpc_route_table_destination_cidr[0].tgw_id) > 0 ? local.vpc_route_table_destination_cidr[0].tgw_id : aws_ec2_transit_gateway.this[0].id
  depends_on = [
